...
class _caixasEBancos extends State<CaixaEBanco> {
  ...
  var snapshotsCaixaEBancoLength; //TODO: CaixaeBanco Length
  ...
  double valoresCaixaeBancoConvertido;
                   ...
                   return SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (BuildContext context, int index) {
                        ...
                        //TODO: Se o valor For igual a int, converta para double.
                        if(caixasebancos['SALDO'].runtimeType == int){
                          //TODO: Convertendo para double
                          valoresCaixaeBancoConvertido = caixasebancos['SALDO'].toDouble();
                        }else{
                          //TODO: Mantendo em int
                          valoresCaixaeBancoConvertido = caixasebancos['SALDO'];
                        }
                        ...
                        if (caixasebancos['SALDO'] >= 0) {
                          _generateData(
                            variNome: 'subtotal',
                            variValor: valoresCaixaeBancoConvertido,
                            variColorgraf: Colors.green,
                            totalNome: 'total',
                            totalValor: selectedCaixa == true
                                ? valorTotalCaixa - valoresCaixaeBancoConvertido
                                : selectedBanco == true
                                    ? valorTotalBanco - valoresCaixaeBancoConvertido
                                    : selectNegativo == true
                                        ? valorTotalNegativo
                                        : valorTotalCaixaEBanco - valoresCaixaeBancoConvertido,
                            totalColorgraf: Colors.black12,
                          );
                        } else {

                          //TODO  REMOVENDO '-' DO VALOR SUBTOTAL
                          String caixaebancoNegativoString = valoresCaixaeBancoConvertido.toString().replaceAll('-', '');
                                      ...
                                      Expanded(
                                        ...
                                        child: Stack(
                                          children: [
                                            ...
                                            Center(
                                              child: Text(
                                                '${calcularPorcentagemEntreDoisValores(subValor: caixasebancos['SALDO'].toDouble(), total: selectedCaixa == true ? valorTotalCaixa : selectedBanco == true ? valorTotalBanco : selectNegativo == true ? valorTotalNegativo : valorTotalCaixaEBanco)}%',
                                                style: TextStyle(
